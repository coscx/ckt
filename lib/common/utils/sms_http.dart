...
*/
class NewSmsHttpUtil {
  static final NewSmsHttpUtil _instance =NewSmsHttpUtil._internal();
  factory NewSmsHttpUtil() => _instance;

  late Dio dio;
  CancelToken cancelToken = CancelToken();
  NewSmsHttpUtil._internal() {
    // BaseOptions、Options、RequestOptions 都可以配置参数，优先级别依次递增，且可以根据优先级别覆盖参数
    BaseOptions options = BaseOptions(
      // 请求基地址,可以包含子路径
      baseUrl: "http://as.gugu2019.com",
