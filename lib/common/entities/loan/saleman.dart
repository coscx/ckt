...
class SaleMan {
  ...
  factory SaleMan.fromJson(Map<String, dynamic> json) => SaleMan(
    code: json.containsKey('code') ? asT<int>(json['code'])! : 0,
    data: json.containsKey('data')
        ? json['data'] == null
        ? null
        : SaleManData.fromJson(asT<Map<String, dynamic>>(json['data'])!)
        : null,
...
class SaleManData {
  ...
  factory SaleManData.fromJson(Map<String, dynamic> json) {
    final List<SaleManDataData>? data =
    json['data'] is List ? <SaleManDataData>[] : null;
    if (data != null) {
      for (final dynamic item in json['data']!) {
        if (item != null) {
          tryCatch(() {
            data.add(
                SaleManDataData.fromJson(asT<Map<String, dynamic>>(item)!));
          });
        }
      }
    }
...
class SaleManDataData {
  ...
  factory SaleManDataData.fromJson(Map<String, dynamic> json) =>
      SaleManDataData(
        csphone:
