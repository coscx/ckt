...
class Lending {
  ...
  factory Lending.fromJson(Map<String, dynamic> json) => Lending(
    ...
    data: json.containsKey('data')
        ? json['data'] == null
        ? null
        : LendingData.fromJson(asT<Map<String, dynamic>>(json['data'])!)
        : null,
...
class LendingData {
  ...
  factory LendingData.fromJson(Map<String, dynamic> json) => LendingData(
    currentPage: json.containsKey('current_page')
        ? asT<int>(json['current_page'])!
        : 0,
    data: json.containsKey('data') ? asT<int>(json['data'])! : 0,
    lastPage:
